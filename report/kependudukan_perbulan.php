...
<html>
    <head>
        <title>Cetak Data Kependudukan Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA KEPENDUDUKAN BULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                        <table class="table table-bordered table-striped table-hover">
                        <tbody>
                <thead>
								<tr>
                                <th>No.</th><th>Nomor Surat</th><th>Nomor KK</th><th>Kepala Keluarga</th><th>Jumlah keluarga</th>
								</tr>
								</thead>
							<tbody>
                            ...
                            $sql = "SELECT * FROM tb_penduduk WHERE substr(nomor_surat,1,7)='$ambilthn-$ambilbln'";
